...
function scene:create( event )
    ...
    bkg = display.newRect( 0.8, 0.5, 0.3, 0.1 ) -- They're set to 0 so they can be clearly set below
        ...
        local mainMenuButton = widget.newButton(
            {
                ...
                fillColor = { default = { 0.5, 0.537, 0.3 }, over = { 1, 0.604, 0.004 } },
                strokeColor = { default = { 0.75, 0.1, 0.9 }, over = { 0.5, 0.3, 0 } },
